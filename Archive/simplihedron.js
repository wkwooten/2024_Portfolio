...
class InteractivePolyhedron {
  constructor(container, options = {}) {
    ...
    this.camera = new THREE.PerspectiveCamera(
      cameraFov, // User-specified FOV
      this.width / this.height, // Aspect ratio
      0.1, // Near clipping plane
      1000 // Far clipping plane
    );

    // Apply user-specified camera settings
    const cameraFov = 55;
    const cameraPosition = new THREE.Vector3(0, 3.9, 7.5);
    const cameraTarget = new THREE.Vector3(0.18, -0.36, -1.55);
